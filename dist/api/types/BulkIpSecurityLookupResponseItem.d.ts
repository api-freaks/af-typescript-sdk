export interface BulkIpSecurityLookupResponseItem {
    ip?: string | undefined;
    security?: BulkIpSecurityLookupResponseItem.Security | undefined;
}
export declare namespace BulkIpSecurityLookupResponseItem {
    interface Security {
