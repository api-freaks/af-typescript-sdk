export interface CommodityLatestRatesResponse {
    ...
    metadata: Record<string, CommodityLatestRatesResponse.Metadata.Value>;
}
export declare namespace CommodityLatestRatesResponse {
    namespace Metadata {
        interface Value {
