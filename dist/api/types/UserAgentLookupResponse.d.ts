export interface UserAgentLookupResponse {
    ...
    device: UserAgentLookupResponse.Device;
    engine: UserAgentLookupResponse.Engine;
    operating_system: UserAgentLookupResponse.OperatingSystem;
}
export declare namespace UserAgentLookupResponse {
    interface Device {
